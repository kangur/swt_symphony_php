 ...
 * up to version 1356536022.
 * Generated on 2012-12-26 16:33:42 
 */
class PropelMigration_1356536022
{
...
CREATE INDEX `event_position_FI_1` ON `event_position` (`user_id`);
...
DROP INDEX `event_position_FI_1` ON `event_position`;

ALTER TABLE `event_position` CHANGE `user_id` `user_id` INTEGER NOT NULL;

ALTER TABLE `event_position` CHANGE `event_id` `event_id` INTEGER NOT NULL;
