...
abstract class BaseEventComment extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'FUBerlin\\ProjectBundle\\Model\\EventCommentPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EventCommentPeer
     */
     ...
     * @return EventComment The current object (for fluent API support)
     */
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = EventCommentPeer::USER_ID;
        }
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = EventCommentPeer::TIMESTAMP;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = EventCommentPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventCommentPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventCommentQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventCommentPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventCommentPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(EventCommentPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(EventCommentPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
        }
        if ($this->isColumnModified(EventCommentPeer::COMMENT)) {
            $modifiedColumns[':p' . $index++]  = '`COMMENT`';
        }
        if ($this->isColumnModified(EventCommentPeer::TIMESTAMP)) {
            $modifiedColumns[':p' . $index++]  = '`TIMESTAMP`';
        }

        $sql = sprintf(
            'INSERT INTO `event_comment` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['EventComment'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventComment'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventCommentPeer::USER_ID)) $criteria->add(EventCommentPeer::USER_ID, $this->user_id);
        ...
        if ($this->isColumnModified(EventCommentPeer::TIMESTAMP)) $criteria->add(EventCommentPeer::TIMESTAMP, $this->timestamp);
     ...
     * objects.
     *
     * @param object $copyObj An object of EventComment (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventComment Clone of current object.
     * @throws PropelException
     */
    ...
    public function getUser(PropelPDO $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addEventComments($this);
             */
        }
    ...
    public function getEvent(PropelPDO $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvent->addEventComments($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EventCommentPeer::DEFAULT_STRING_FORMAT);
    }
