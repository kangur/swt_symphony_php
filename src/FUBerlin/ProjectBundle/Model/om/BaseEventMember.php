...
abstract class BaseEventMember extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'FUBerlin\\ProjectBundle\\Model\\EventMemberPeer';
     ...
     * @return EventMember The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = EventMemberPeer::USER_ID;
        }

        if ($this->aMemberUser !== null && $this->aMemberUser->getId() !== $v) {
            $this->aMemberUser = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EventMemberPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aMemberUser !== null && $this->user_id !== $this->aMemberUser->getId()) {
            $this->aMemberUser = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EventMemberPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EventMemberQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EventMemberPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMemberUser !== null) {
                if ($this->aMemberUser->isModified() || $this->aMemberUser->isNew()) {
                    $affectedRows += $this->aMemberUser->save($con);
                }
                $this->setMemberUser($this->aMemberUser);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EventMemberPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(EventMemberPeer::EVENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`EVENT_ID`';
        }

        $sql = sprintf(
            'INSERT INTO `event_member` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aMemberUser !== null) {
                if (!$this->aMemberUser->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aMemberUser->getValidationFailures());
                }
            }
    ...
    {
        if (isset($alreadyDumpedObjects['EventMember'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EventMember'][serialize($this->getPrimaryKey())] = true;
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aMemberUser) {
                $result['MemberUser'] = $this->aMemberUser->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
            if (null !== $this->aEvent) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EventMemberPeer::USER_ID)) $criteria->add(EventMemberPeer::USER_ID, $this->user_id);
    ...
    {
        $criteria = new Criteria(EventMemberPeer::DATABASE_NAME);
        $criteria->add(EventMemberPeer::USER_ID, $this->user_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EventMember (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EventMember Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setMemberUser(User $v = null)
    {
        if ($v === null) {
            $this->setUserId(NULL);
        } else {
     ...
     * @throws PropelException
     */
    public function getMemberUser(PropelPDO $con = null)
    {
        if ($this->aMemberUser === null && ($this->user_id !== null)) {
            $this->aMemberUser = UserQuery::create()->findPk($this->user_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMemberUser->addEventMembers($this);
             */
        }

        return $this->aMemberUser;
    }
    ...
    public function getEvent(PropelPDO $con = null)
    {
        if ($this->aEvent === null && ($this->event_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEvent->addEventMembers($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EventMemberPeer::DEFAULT_STRING_FORMAT);
    }
